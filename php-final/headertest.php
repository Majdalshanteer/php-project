...
<body>
    <header>
        <nav class="navbar ">
           ...
           <a href="index.php"><img src="logo-removebg-preview_2.png" alt="HTML tutorial" style="width:90px;height:70px;"></a>
                <div class="nav navbar-nav1">
                    <a href="index.php" class="btn btn3">HOME</a>
                    <a href="shop.php" class="btn btn3">SHOP</a>
                    <a href="about.php" class="btn btn3">ABOUT</a>
                    <a href="contact.php" class="btn btn3">CONTACT</a>
                ...
                <div class="nav navbar-nav2"><?php
                                                if (empty($_SESSION['name']) || $_SESSION['name'] == '') {
                                                    ...
                                                    echo "<img style='width:40px; height:40px; margin-right:2px;' src='images/avatar-removebg-preview (1).png'><font color='#7386D5
                                                    '><a href='userpage.php'class='btn btn2'><h6 style= margin-right:10px; >Hello  " . $_SESSION['name'] . " </h6></font></a>";
                                                }
                                                ?>
                    <?php
                    if (empty($_SESSION['name']) || $_SESSION['name'] == '') {
    ...
    Sign Up</a>";
                    ...
                    <a href="last.php" class="btn btn2"><span class="badge text-bg-secondary">                    <?php
