...
//comment data
$sql1 = "SELECT * FROM comment WHERE item_id='" . $_GET["id"] . "' AND approve=1  "  ;
$result2 = $conn->query($sql1);



// number of comments
  $sql3 = "SELECT * FROM comment WHERE item_id='" . $_GET["id"] . "' AND approve=1  ";
...
if(isset($_POST['submit'])){
    ...
    $sql4 = "INSERT INTO comment(name,email,comment,item_name,item_id) 
        VALUES('$name','$email','$comment', '$x'  ,'$y')";
                    ...
                    <div class="container-fliud">
                        <div class="wrapper row">
                            ...
                            <div class="details col-md-6">
                                ...
                                <div class="action">
                                <a href="last.php"> <button class="add-to-cart btn" style="background:#7386D5" type="button">add to cart</button></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 fl_icon">
                                <div class="form-group fl_icon">
                                    ...
                                    <input class="form-input" type="email" placeholder="Your email" name="email">
                                </div>
                            </div>
                            <div class="col-xs-12">
