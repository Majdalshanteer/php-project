                ...
                <form action="" method="GET">
                    <div>
                        <div class="d-flex">
                            ...
                            <input style="width:50px;margin-right:5px;" type="text" name="start_price" value="<?php if (isset($_GET['start_price'])) {
                            ...
                            <label for="">End:&nbsp;</label>
                            <input style="width:50px;height:" type="text" name="end_price" value="<?php if (isset($_GET['end_price'])) {
                                                                            echo $_GET['end_price'];
                                                                        } else {
                                                                            echo "0";
        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    <button type="button" id="sidebarCollapse" class="navbar-btn" style="background:#F8F8F8">
                        <span></span>
                        <span></span>
                        <span></span>
                    </button>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <form style="width:70% ;" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                            ...
                            <span>
                                <button class="btn px-4 mt-2 ml-3" style="background:#7386D5;color:white" name="serachBtn" type="submit">Search</button>
                                <button type="submit" name="reset" style="background:#7386D5;color:white" class="btn  px-4 mt-2 ml-3">Reset</button>
                            </span>
                        </form>
                    </div>
                </div>
                            ...
                            <div class="card h-90 mb-4  " style=" margin:auto ;max-width:280px  ;">
                                <div class="card p-4">
                                    ...
                                    <div class="text-center d-flex flex-column" style="height: 140px; padding:2px;">
                                        <a href="product_details.php?id=<?php echo $row["id"] ?>" class="item_name_link" style="color:#874cad
 ;">
                                            <h5 class="px-2 "><?= $row['name_item']; ?></h5>
                                        </a>
                                        <h6 class="card-title"><?php echo '$' . $row["price"] ?></h6>
                                        <form method="post" action="shop.php?id=<?php echo $row["id"] ?>">
                                            <div class="btns d-flex">
                                                <!-- <label for="quantity" style=";">Qty: </label> -->
                                                <input type="number" min="1" max="10" name="quantity" style="width:70px;margin-right:4px;" value="1" /><br>
                                                ...
                                                <input type="submit" class="btn" style="background-color:#7386D5;color:white"  value="Add To Cart" name="addCart">
                                            </div>
                                        </form>
                                    </div>
                                </div>
