...
$email = $name  = $mobile= $password = $passwordConfirm = null;
$emailErr = $nameErr = $mobileErr = $passwordErr = $passwordConfirmErr = null;
$note = null;
...
// if(isset($_POST['submit'])) {
    if ( isset($name)  &&isset($email) && isset($mobile)  && isset($password)&& isset($passwordConfirm) ) {
