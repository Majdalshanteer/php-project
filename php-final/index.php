                ...
                ?>
                        ...
                        <div class="col ">
                            <div class="card border-0">
                                ...
                                <div class="card-body">
                                    <h6 class="card-title text-center"><a style="text-decoration: none; text-align: center;" href="shop.php?catId
=<?php echo $row["category_id"] ?>"> <?php echo $row["category_name"] ?> </a></h6>
