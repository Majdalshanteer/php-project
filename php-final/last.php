...
<td><a onclick="return confirm('Do you want to delete this record?')"  href="last.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger"><button class='btn btn-danger'><img src="trash3.svg"></button></span></a></td>
</tr>
<?php
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mt-2">
                        ...
                        <a href="shipping.php"><button type="submit" class="btn-block btn-blue" name="checkout">
                            <span>
                                <span id="checkout" style="color:white">Place Your Order</span></a>
