...
<body style="background-color:white">
    ...
    <div id="container" class="container-fluid " style="margin-bottom:70px;">

        <h2 class="mainHeading" style="color:#563c9f ; background-color:white">About Us</h2>
        ...
        <div class="ourComp">
            ...
            <a href="shop.php" ><button style="border-radius:5px;">More</button></a>
